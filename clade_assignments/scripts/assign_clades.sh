...
python3 ./identifyClades.py ../alignments/ALIGNED-B_yam.fa ../clade_defs/clades_yam_ha.tsv --reference ../references/reference_yam_ha.gb --output ../assignments/B_yam.tsv

python3 ./identifyClades.py ../alignments/ALIGNED-B_vic.fa ../clade_defs/clades_vic_ha.tsv --reference ../references/reference_vic_ha.gb --output ../assignments/B_vic.tsv
